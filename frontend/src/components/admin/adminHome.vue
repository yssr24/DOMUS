        ...
        <nav class="sidebar-nav">
          ...
          >
            <span class="sidebar-icon">
              <img src="../../assets/domus.png" alt="DOMUS Logo" class="sidebar-logo" />
            </span>
            <span v-if="showSidebar" class="sidebar-title">Administration</span>
          </a>
          <a
            v-if="!isNarrow || showSidebar"
            href="#"
          ...
          >
            <span class="sidebar-icon">
              <svg width="22" height="22" fill="none" viewBox="0 0 24 24">
                <path d="M3 13h8V3H3v10zm0 8h8v-6H3v6zm10 0h8V11h-8v10zm0-18v6h8V3h-8z" fill="#e6b23a"/>
              </svg>
            </span>
          ...
          >
            <span class="sidebar-icon">
              <svg width="22" height="22" fill="none" viewBox="0 0 24 24">
                <path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5s-3 1.34-3 3 1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05C17.16 13.36 19 14.28 19 15.5V19h5v-2.5c0-2.33-4.67-3.5-7-3.5z" fill="#e6b23a"/>
              </svg>
            </span>
          ...
          <a
            ...
            href="#"
            class="sidebar-link"
            :class="{ active: route.path === '/admin/project-management' }"
            @click.prevent="goTo('/admin/project-management')"
          >
            <span class="sidebar-icon">
              <svg width="22" height="22" fill="none" viewBox="0 0 24 24">
                <path d="M3 13h2v-2H3v2zm0 4h2v-2H3v2zm0-8h2V7H3v2zm4 8h2v-2H7v2zm0-4h2v-2H7v2zm0-8v2h2V3H7zm4 8h2v-2h-2v2zm0 4h2v-2h-2v2zm0-8v2h2V3h-2zm4 8h2v-2h-2v2zm0 4h2v-2h-2v2zm0-8v2h2V3h-2z" fill="#e6b23a"/>
              </svg>
            </span>
          ...
          <a
            ...
            href="#"
            class="sidebar-link"
            :class="{ active: route.path === '/admin/task-management' }"
            @click.prevent="goTo('/admin/task-management')"
          >
            <span class="sidebar-icon">
              <svg width="22" height="22" fill="none" viewBox="0 0 24 24">
                <path d="M9 17H7v-2h2v2zm0-4H7v-2h2v2zm0-4H7V7h2v2zm4 8h-2v-2h2v2zm0-4h-2v-2h2v2zm0-4h-2V7h2v2zm4 8h-2v-2h2v2zm0-4h-2v-2h2v2zm0-4h-2V7h2v2z" fill="#e6b23a"/>
              </svg>
            </span>
          ...
          <a
            ...
            href="#"
            class="sidebar-link"
            :class="{ active: route.path === '/admin/file-and-document' }"
            @click.prevent="goTo('/admin/file-and-document')"
          >
            <span class="sidebar-icon">
              <svg width="22" height="22" fill="none" viewBox="0 0 24 24">
                <path d="M6 2h9a2 2 0 012 2v16a2 2 0 01-2 2H6a2 2 0 01-2-2V4a2 2 0 012-2zm0 2v16h9V4H6zm2 2h5v2H8V6zm0 4h5v2H8v-2zm0 4h5v2H8v-2z" fill="#e6b23a"/>
              </svg>
            </span>
          ...
          <a
            ...
            href="#"
            class="sidebar-link"
            :class="{ active: route.path === '/admin/client-portal' }"
            @click.prevent="goTo('/admin/client-portal')"
          >
            <span class="sidebar-icon">
              <svg width="22" height="22" fill="none" viewBox="0 0 24 24">
                <path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z" fill="#e6b23a"/>
              </svg>
            </span>
          ...
          <a
            ...
            href="#"
            class="sidebar-link"
            :class="{ active: route.path === '/admin/notification-center' }"
            @click.prevent="goTo('/admin/notification-center')"
          >
            <span class="sidebar-icon">
              <svg width="22" height="22" fill="none" viewBox="0 0 24 24">
                <path d="M12 22c1.1 0 2-.9 2-2h-4a2 2 0 002 2zm6-6V11c0-3.07-1.63-5.64-4.5-6.32V4a1.5 1.5 0 10-3 0v.68C7.63 5.36 6 7.92 6 11v5l-1.7 1.7a1 1 0 00.7 1.7h14a1 1 0 00.7-1.7L18 16z" fill="#e6b23a"/>
              </svg>
            </span>
          ...
          <a
            ...
            href="#"
            class="sidebar-link"
            :class="{ active: route.path === '/admin/system-security' }"
            @click.prevent="goTo('/admin/system-security')"
          >
            <span class="sidebar-icon">
              <svg width="22" height="22" fill="none" viewBox="0 0 24 24">
                <path d="M12 17a2 2 0 002-2v-2a2 2 0 00-2-2 2 2 0 00-2 2v2a2 2 0 002 2zm6-2v-2a6 6 0 00-12 0v2a6 6 0 0012 0z" fill="#e6b23a"/>
              </svg>
            </span>
          ...
          <a
            ...
            href="#"
            class="sidebar-link"
            :class="{ active: route.path === '/admin/billing-and-finance' }"
            @click.prevent="goTo('/admin/billing-and-finance')"
          >
            <span class="sidebar-icon">
              <svg width="22" height="22" fill="none" viewBox="0 0 24 24">
                <path d="M17 9V7a5 5 0 00-10 0v2a2 2 0 00-2 2v7a2 2 0 002 2h10a2 2 0 002-2v-7a2 2 0 00-2-2zm-8-2a3 3 0 016 0v2H9V7zm8 11H7v-7h10v7z" fill="#e6b23a"/>
              </svg>
            </span>
